...
Draw_ZT_I8_NWLR::
	DRAW_ZT_I8 x1,DRAW_LR,top,WRAPPED,0,0
	DRAW_ZT_I8 x2,DRAW_LR,bottom,WRAPPED,0,0
	ret

Draw_ZT_I8_NWRL::
	DRAW_ZT_I8 x1,DRAW_RL,top,WRAPPED,0,0
	DRAW_ZT_I8 x2,DRAW_RL,bottom,WRAPPED,0,0
	ret
endif
;Wraps
...
ECHO NON-WRAPPED SPECIAL CASE ENABLED
Draw_ZTF_I8_NWLR::
    DRAW_ZT_I8 x1,DRAW_LR,top,NON_WRAPPED,1,0
    DRAW_ZT_I8 x2,DRAW_LR,bottom,NON_WRAPPED,1,0
	ret

Draw_ZTF_I8_NWRL::
    DRAW_ZT_I8 x1,DRAW_RL,top,NON_WRAPPED,1,0
    DRAW_ZT_I8 x2,DRAW_RL,bottom,NON_WRAPPED,1,0
	ret
...
Draw_ZTF_I8_NWLR::
    DRAW_ZT_I8 x1,DRAW_LR,top,WRAPPED,1,0
    DRAW_ZT_I8 x2,DRAW_LR,bottom,WRAPPED,1,0
	ret

Draw_ZTF_I8_NWRL::
    DRAW_ZT_I8 x1,DRAW_RL,top,WRAPPED,1,0
    DRAW_ZT_I8 x2,DRAW_RL,bottom,WRAPPED,1,0
	ret
endif
;Wraps
...
ECHO NON-WRAPPED SPECIAL CASE ENABLED
Draw_ZTI_I8_NWLR::
	DRAW_ZTI_I8 x1,DRAW_LR,top,NON_WRAPPED,0,0
	DRAW_ZTI_I8 x2,DRAW_LR,bottom,NON_WRAPPED,0,0
	ret

Draw_ZTI_I8_NWRL::
	DRAW_ZTI_I8 x1,DRAW_RL,top,NON_WRAPPED,0,0
	DRAW_ZTI_I8 x2,DRAW_RL,bottom,NON_WRAPPED,0,0
	ret
...
Draw_ZTI_I8_NWLR::
	DRAW_ZTI_I8 x1,DRAW_LR,top,WRAPPED,0,0
	DRAW_ZTI_I8 x2,DRAW_LR,bottom,WRAPPED,0,0
	ret

Draw_ZTI_I8_NWRL::
	DRAW_ZTI_I8 x1,DRAW_RL,top,WRAPPED,0,0
	DRAW_ZTI_I8 x2,DRAW_RL,bottom,WRAPPED,0,0
	ret
endif
;Wraps
...
ECHO NON-WRAPPED SPECIAL CASE ENABLED
Draw_ZTIF_I8_NWLR::
    DRAW_ZTI_I8 x1,DRAW_LR,top,NON_WRAPPED,1,0
    DRAW_ZTI_I8 x2,DRAW_LR,bottom,NON_WRAPPED,1,0
	ret

Draw_ZTIF_I8_NWRL::
    DRAW_ZTI_I8 x1,DRAW_RL,top,NON_WRAPPED,1,0
    DRAW_ZTI_I8 x2,DRAW_RL,bottom,NON_WRAPPED,1,0
	ret
...
Draw_ZTIF_I8_NWLR::
    DRAW_ZTI_I8 x1,DRAW_LR,top,WRAPPED,1,0
    DRAW_ZTI_I8 x2,DRAW_LR,bottom,WRAPPED,1,0
	ret

Draw_ZTIF_I8_NWRL::
    DRAW_ZTI_I8 x1,DRAW_RL,top,WRAPPED,1,0
    DRAW_ZTI_I8 x2,DRAW_RL,bottom,WRAPPED,1,0
	ret
endif
;Wraps
